...
$host   = "sql110.infinityfree.com";     // Máy chủ MySQL
$user   = "if0_40823905";                // Tên đăng nhập MySQL
$pass   = "s4Lc2Z1FP6d";                 // Mật khẩu Hosting (Bạn đã điền sẵn)
$dbname = "if0_40823905_shoppremium";    // Tên Database
